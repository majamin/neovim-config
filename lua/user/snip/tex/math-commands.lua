...
-- personal imports
-- ]
local tex = require("user.snip.tex.utils.conditions")
local auto_backslash_snippet =
  require("user.snip.tex.utils.scaffolding").auto_backslash_snippet
local symbol_snippet = require("user.snip.tex.utils.scaffolding").symbol_snippet
local single_command_snippet =
  require("user.snip.tex.utils.scaffolding").single_command_snippet
local postfix_snippet =
  require("user.snip.tex.utils.scaffolding").postfix_snippet
...
for _, v in ipairs(auto_backslash_specs) do
  table.insert(
    ...
    auto_backslash_snippet({ trig = v }, { condition = tex.in_math })
  )
end
